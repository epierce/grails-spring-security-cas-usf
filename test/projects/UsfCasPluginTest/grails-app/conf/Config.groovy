...
grails.plugins.springsecurity.cas.proxyCallbackUrl = 'http://localhost:8080/UsfCasPluginTest/secure/receptor' 
...
grails.plugins.springsecurity.cas.serviceUrl = 'http://localhost:8080/UsfCasPluginTest/j_spring_cas_security_check'
